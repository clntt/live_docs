...
import { LiveBlocksPlugin } from '@lexical/react/plugin/liveblockPlugin';

import { FloatingComposer, FloatingThreads, LiveblocksPlugin } from '@liveblocks/react-lexical';
